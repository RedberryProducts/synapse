...
- The playground shows an assistant-side pending response indicator immediately after send, and clears or replaces it on the first meaningful stream event so slow provider startup never looks stalled
